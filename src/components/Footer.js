      ...
      <div className="container">
        ...
        <div>
          ...
          <div className='footer__about'>
            ...
            <p>Hướng đến mục tiêu mang lại niềm vui ăn mặc mới mỗi ngày cho hàng triệu người tiêu dùng Việt. Hãy cùng Yolo hướng đến một cuộc sống đầy năng động, tích cực hơn</p>
          </div>
        </Grid>
      </div>
    </footer>
